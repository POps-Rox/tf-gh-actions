...
- **Dependency Manifest:** `image/setup.py` (production deps: requests, python-hcl2, canonicaljson), `tests/requirements.txt` (dev/test deps)
- **Lockfile:** None (no pip lockfile configured)
- **Audit Command:** `pip-audit` (if installed)
